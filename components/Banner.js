...
const Banner = ({
  title = "Growsin — SEBI-Registered Investment Advisory",
  subTitle = "Client-first investment advice backed by research",
        ...
        <div className="row align-items-center">
          <div className="col-xl-6">
            <div className="mil-banner-text">
              ...
              <div className="mil-buttons-frame">
                ...
                <Link href="/services" className="mil-btn mil-border mil-md" style={{ marginLeft: 15 }}>
                  Explore Services
                </Link>
              </div>
            </div>
          ...
          <div className="col-xl-6">
            <div className="mil-banner-img">
              <img src={img} alt="Growsin banner" style={style} />
            </div>
          </div>
        </div>
      </div>
...
export const PageBanner = ({
  title = "Trusted investment advice, powered by data and compliance",
  pageName = "About Growsin",
}) => {
  return (
